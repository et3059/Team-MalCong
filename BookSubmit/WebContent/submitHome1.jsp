...
<link rel="stylesheet" href="./css1/custom1.css">
<link rel="stylesheet" href="./css1/bootstrap1.min.css">

<body>
   <div class="headBar bg-light">
      <span class="ml-2" style="float:left;"><a href="search.jsp"><img src="./image1/search.svg" width="20px"></a></span>
      <span class="ml-2" style="float:left;"><a href="javascript:history.back()"><img src="./image1/arrow-left.svg" width="20px"></a></span>
      <span style="float:center;"><a class="navbar-brand" href="index.jsp" style="text-align:center;">북서밋</a></span>
      <span class="mr-2" style="float:right;"><a href="myHome.jsp"><img src="./image1/person-circle.svg" width="30px"></a></span>
   </div>
   <div>
      <span class="ml-2 mt-2" style="float:left;"><h1>투고게시판</h1></span>
      <span class="mr-2 mt-2" style="float:right;"><a href="submitWrite.jsp"><img src="./image1/pencil.svg" width="30px"></a></span>
  ...
  <div class="card">
    <img src="./image1/search.svg" class="card-img-top" alt="...">
    <div class="card-body">
...
<span class="ml-2" style="float:left;"><a href="search.jsp"><img src="./image1/search.svg" width="35px"></a></span>
<div id="margin">
<span class="mr-2 mt-2" style="float:left;"><a href="submitWrite.jsp"><img src="./image1/pencil.svg" width="35px"></a></span>
</div>
